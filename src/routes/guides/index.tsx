...
export const Route = createFileRoute("/guides/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay-ai.lovable.app/guides" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay-ai.lovable.app/guides" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay-ai.lovable.app/guides" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay-ai.lovable.app/guides" },
    ],
  }),
