...
export const Route = createFileRoute("/guides/plumbing-automation")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay-ai.lovable.app/guides/plumbing-automation" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay-ai.lovable.app/guides/plumbing-automation" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay-ai.lovable.app/guides/plumbing-automation" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay-ai.lovable.app/guides/plumbing-automation" },
    ],
  }),
  component: Page,
});
