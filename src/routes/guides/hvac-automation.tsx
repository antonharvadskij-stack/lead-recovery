...
export const Route = createFileRoute("/guides/hvac-automation")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay.lovable.app/guides/hvac-automation" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay.lovable.app/guides/hvac-automation" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay.lovable.app/guides/hvac-automation" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay.lovable.app/guides/hvac-automation" },
    ],
  }),
  component: Page,
});
