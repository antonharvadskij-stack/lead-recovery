...
export const Route = createFileRoute("/guides/missed-call-text-back")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay-ai.lovable.app/guides/missed-call-text-back" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay-ai.lovable.app/guides/missed-call-text-back" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay-ai.lovable.app/guides/missed-call-text-back" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay-ai.lovable.app/guides/missed-call-text-back" },
    ],
  }),
  component: Page,
});
