...
export const Route = createFileRoute("/guides/lead-follow-up-sequence")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay-ai.lovable.app/guides/lead-follow-up-sequence" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay-ai.lovable.app/guides/lead-follow-up-sequence" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay-ai.lovable.app/guides/lead-follow-up-sequence" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay-ai.lovable.app/guides/lead-follow-up-sequence" },
    ],
  }),
  component: Page,
});
