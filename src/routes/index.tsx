...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://leadrelay-ai.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://leadrelay-ai.lovable.app/" },
      { rel: "alternate", hrefLang: "en", href: "https://leadrelay-ai.lovable.app/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://leadrelay-ai.lovable.app/" },
    ],
  }),
  component: Index,
});
